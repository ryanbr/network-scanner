...
function formatDomain(domain, options = {}) {
  const { localhost = false, localhostAlt = false, plain = false, adblockRules = false, dnsmasq = false, resourceType = null } = options;
...
function getFormatDescription(options = {}) {
  const { localhost = false, localhostAlt = false, plain = false, adblockRules = false, dnsmasq = false } = options;
