        ...
        try {
          ...
          if (digResult.success) {
            ...
            if (hasDig) {
              ...
              if (forceDebug && siteConfig.verbose === 1) {
                logToConsoleAndFile(`${messageColors.highlight('[dig-and]')} Terms checked: ${digTerms.join(' AND ')}, matched: ${digMatched}`);
              }
            }
            ...
            if (hasDigOr) {
              ...
              if (forceDebug && siteConfig.verbose === 1) {
                logToConsoleAndFile(`${messageColors.highlight('[dig-or]')} Terms checked: ${digOrTerms.join(' OR ')}, matched: ${digOrMatched}`);
              }
            }
