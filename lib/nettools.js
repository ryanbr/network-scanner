...
const GLOBAL_DIG_CACHE_TTL = 14400000; // 4 hours (persisted to disk between runs)
...
const GLOBAL_WHOIS_CACHE_TTL = 18000000; // 5 hours (persisted to disk between runs)
