...
const GLOBAL_DIG_CACHE_TTL = 36000000; // 10 hours (persisted to disk between runs)
const GLOBAL_DIG_CACHE_MAX = 800;
...
const GLOBAL_WHOIS_CACHE_TTL = 43200000; // 12 hours (persisted to disk between runs)
const GLOBAL_WHOIS_CACHE_MAX = 800;
