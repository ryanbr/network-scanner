...
const dnsCacheStats = { digHits: 0, digMisses: 0, digFailures: 0, whoisHits: 0, whoisMisses: 0, freshDig: [], freshWhois: [] };
          ...
          if (!digResult) {
            ...
            if (pendingDigLookups.has(digCacheKey)) {
              ...
              if (digResult.success) {
                ...
                // dead host. Counted so the end-of-run summary can surface how
                // many dig-gated matches the link cost this run (not cached, so
