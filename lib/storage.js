 ...
 *     elsewhere read back null because the seed never applied. This is the same
 *     breadth a `.domain.com` cookie has, so the two features agree. A redirect
 ...
 * routine shape. This is the same breadth a `.domain.com` cookie has.
  ...
  try {
    await page.evaluateOnNewDocument((payload) => {
      try {
        ...
        // while "abc.xyz.domain.com" passes. Same breadth as a ".domain.com"
        // cookie, which is the sibling feature's behaviour.
