    ...
    try {
      await page.evaluateOnNewDocument((userAgent, debugEnabled) => {
        ...
        safeExecute(() => {
          ...
          safeDefinePropertyLocal(navigator, 'languages', CACHED_DESCRIPTORS.getter(() => languages));
          safeDefinePropertyLocal(navigator, 'language', CACHED_DESCRIPTORS.getter(() => languages[0]));
        }, 'language spoofing');
        ...
        safeExecute(() => {
          ...
          safeDefinePropertyLocal(navigator, 'vendor', CACHED_DESCRIPTORS.getter(() => vendor));
          safeDefinePropertyLocal(navigator, 'product', CACHED_DESCRIPTORS.getter(() => product));
        ...
        //
        safeExecute(() => {
          safeDefinePropertyLocal(navigator, 'hardwareConcurrency', CACHED_DESCRIPTORS.getter(() => [4, 6, 8, 12][Math.floor(Math.random() * 4)]));
