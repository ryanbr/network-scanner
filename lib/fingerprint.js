    ...
    try {
      await page.evaluateOnNewDocument((userAgent, debugEnabled) => {
        ...
        safeExecute(() => {
          ...
          safeDefinePropertyLocal(navigator, 'webdriver', CACHED_DESCRIPTORS.getter(() => undefined));
        }, 'webdriver removal');
        ...
        safeExecute(() => {
          ...
          automationProps.forEach(prop => {
            try {
              ...
              safeDefinePropertyLocal(window, prop, CACHED_DESCRIPTORS.getter(() => undefined));
              safeDefinePropertyLocal(navigator, prop, CACHED_DESCRIPTORS.getter(() => undefined));
            } catch (e) {}
          });
        ...
        safeExecute(() => {
          ...
          safeDefinePropertyLocal(navigator, 'plugins', CACHED_DESCRIPTORS.getter(() => pluginsArray));
        }, 'plugins spoofing');
        ...
        safeExecute(() => {
          ...
          const languageProps = {
            languages: CACHED_DESCRIPTORS.getter(() => languages),
            language: CACHED_DESCRIPTORS.getter(() => languages[0])
          };
        ...
        safeExecute(() => {
          ...
          const vendorProps = {
            vendor: CACHED_DESCRIPTORS.getter(() => vendor),
            product: CACHED_DESCRIPTORS.getter(() => product)
          };
        ...
        safeExecute(() => {
          const hardwareProps = {
            hardwareConcurrency: CACHED_DESCRIPTORS.getter(() => [4, 6, 8, 12][Math.floor(Math.random() * 4)])
          };
        ...
        safeExecute(() => {
          ...
          const screenProps = {
            width: CACHED_DESCRIPTORS.getter(() => resolution.width),
            height: CACHED_DESCRIPTORS.getter(() => resolution.height),
            availWidth: CACHED_DESCRIPTORS.getter(() => resolution.width),
            availHeight: CACHED_DESCRIPTORS.getter(() => resolution.height - 40)
          };
  ...
  try {
    await page.evaluateOnNewDocument(({ spoof, debugEnabled }) => {
      ...
      const navigatorProps = {
        platform: CACHED_DESCRIPTORS.getter(() => spoof.platform),
        deviceMemory: CACHED_DESCRIPTORS.getter(() => spoof.deviceMemory),
        hardwareConcurrency: CACHED_DESCRIPTORS.getter(() => spoof.hardwareConcurrency)
      };
      ...
      ['width', 'height', 'availWidth', 'availHeight', 'colorDepth', 'pixelDepth'].forEach(prop => {
        if (spoof.screen[prop] !== undefined) {
          screenSpoofProps[prop] = CACHED_DESCRIPTORS.getter(() => spoof.screen[prop]);
        }
      });
