...
// Shared with lib/adblock.js: both engines must agree on which urls have no host,
// or they diverge on exactly the inputs neither can match.
const { isHostlessUrl } = require('./site-scope');
