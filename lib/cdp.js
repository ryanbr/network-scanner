...
// Pre-allocated singleton for the early-exit case (CDP not enabled OR not in
// debug mode). Same pattern as NOOP_CLEANUP — every non-CDP scan was
// allocating a fresh {session: null, cleanup, isEnhanced: false} object via
// createSessionResult(). Frozen so callers can't mutate the shared instance.
