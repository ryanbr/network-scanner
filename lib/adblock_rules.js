// === Adblock Rules Parser (adblock_rules.js) v2.1 - Full Optimization ===
// Supports EasyList/AdBlock Plus filter syntax
// Performance: Map-based O(1) lookups + URL parsing cache
...
function createMatcher(rules, options = {}) {
  ...
  return {
    ...
    shouldBlock(url, sourceUrl = '', resourceType = '') {
      try {
        // Check cache first for URL parsing (60% faster)
